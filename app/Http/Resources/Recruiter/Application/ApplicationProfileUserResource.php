...
class ApplicationProfileUserResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            'id' => $this['user_id'],
            'avatar' => $this['application_user']['is_public_avatar'] == User::STATUS_PUBLIC_AVATAR ? FileHelper::getFullUrl($this['avatar_banner']) : null,
            'avatar_details' => $this['application_user']['is_public_avatar'] == User::STATUS_PUBLIC_AVATAR ? MultipleImageResoure::collection($this['avatar_details']) : null,
